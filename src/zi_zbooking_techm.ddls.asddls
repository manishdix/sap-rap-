...
define view entity ZI_ZBOOKING_TECHM
  as select from zbooking_ayush
  association        to parent ZI_ZTRAVEL_TECH_M  as _Travel         on  $projection.TravelId = _Travel.TravelId
  composition [0..*] of ZI_ZBOOKSUPPL_TECH_M      as _Bookingsuppl
